...
<div style="background:#fee2e2;border-left:4px solid #ef4444;padding:16px;border-radius:4px;margin:0 0 24px;font-size:14px;color:#991b1b;">
    {{ $customerName ?? 'A customer' }} declined your proposal.
</div>
...
<table style="width:100%;border-collapse:collapse;">
    ...
    <tr><td style="padding:8px 0;font-size:14px;color:#94a3b8;border-bottom:1px solid #f8fafc;">Declined at</td><td style="padding:8px 0;font-size:14px;color:#334155;border-bottom:1px solid #f8fafc;">{{ $rejectedAt }}</td></tr>
    @if($rejectionReason)
    <tr><td style="padding:8px 0;font-size:14px;color:#94a3b8;border-bottom:1px solid #f8fafc;">Reason</td><td style="padding:8px 0;font-size:14px;color:#334155;border-bottom:1px solid #f8fafc;">{{ $rejectionReason }}</td></tr>
    @endif
</table>
